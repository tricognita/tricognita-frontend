 ...
 * git history (git log -- app/dashboard/iac/page.tsx).
 *
...
export default function IacPage() {
  return (
    <PageShell
      eyebrow="Pipeline · IaC"
      title="IaC Scanner"
      description="Static-analysis of Terraform, CloudFormation, and Pulumi templates for misconfigurations before deploy."
      meta={<StatusDot intent="warning" size="sm" label="Pre-release validation" />}
    >
      <EmptyState
        variant="bordered"
        icon={<FileCode size={32} className="text-[var(--amber-clay)]" />}
        title="This module is in pre-release validation."
        description="Scanner integration with your CI runners is in pilot. The view reactivates once your team is onboarded to the IaC validation cohort."
        action={
